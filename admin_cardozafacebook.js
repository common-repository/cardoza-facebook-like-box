jQuery(document).ready(function()
{
	function loadfbIframe()
	{
		...
		var videos='';
		if(jQuery("[name=frm_videos]").is(":checked"))			videos="true";
	...
	jQuery("[name='frm_show_faces'],[name='frm_stream'],[name='frm_events'],[name='frm_message'],[name='frm_header'],[name='frm_small_header'],[name='frm_lang'],[name='frm_videos']").change(function()
	{
